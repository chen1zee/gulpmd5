define('page/home/companyInfo', function(require, exports, module){ require("common");
require("jquery");
...
$(function () {
    ...
    //---初始化 文字包裹框的宽度
    var rollingWord = "经常在微信图文中看到一些特别棒的排版,很想知道这些精美的样式都是从哪里找到的,我也是做微信运营的 ";

    $("#companyMessage").width(rollingWord.length * 16).html(rollingWord);
    ...
    function Rolling(){
        ...
        this.rolling = function (opt){
            ...
            len = $(opt.id).width() - $(opt.wrap).width() + 100;
            nowX = -40;//---文字滚动位置
